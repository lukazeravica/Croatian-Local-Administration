...
select add_value_in_people_table('Zeljko Malnar',2347);

-- Counties Table

select add_value_in_counties_table ('Republika Pescenica',22);

-- Administrative Units Table

select add_value_in_administrative_units_table ('Municipality','Republic of Pescenica','Stara Pescenica 10',
'01 668 994','01 668 994','nocnamora@z1.hr','www.nocnamora.hr','Republic of Pescenica', 577,22);

-- Administrative Unit Incumbents Table

select add_value_in_administrative_unit_incumbents_table(576,1,2017,2347);
